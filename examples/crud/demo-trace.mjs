 ...
 *
 *   node examples/crud/demo-trace.mjs
 *   node packages/cli/bin/flowlens.mjs trace examples/crud
 *
...
const events = [
  ...recordFlow({
    ...
    spans: [
      {
        kind: 'method',
        name: 'OrdersController.create',
        durationMs: 2,
        attrs: { class: 'OrdersController', method: 'create' },
      },
      {
        kind: 'method',
      ...
      {
        kind: 'db',
        name: 'products.countDocuments',
        durationMs: 82,
        attrs: { collection: 'products', operation: 'countDocuments' },
      },
      {
        kind: 'db',
        name: 'orders.create',
  ...
  ...recordFlow({
    ...
    spans: [
      {
        kind: 'method',
        name: 'CustomersController.create',
        durationMs: 2,
        attrs: { class: 'CustomersController', method: 'create' },
      },
      {
        kind: 'method',
        name: 'CustomersService.create',
        durationMs: 54,
        attrs: { class: 'CustomersService', method: 'create' },
      },
      {
        kind: 'db',
        name: 'customers.create',
        durationMs: 38,
        attrs: { collection: 'customers', operation: 'create' },
      },
      {
        kind: 'db',
        name: 'auditlogs.create',
...
console.log('next: node packages/cli/bin/flowlens.mjs trace examples/crud');
