@echo off
rem Flowslens launcher for Windows.
rem
rem Run Flowslens straight from a checkout - no install step, no global package:
rem
...
if errorlevel 1 (
  echo Flowslens needs Node.js ^(18.18 or newer^). Install it from https://nodejs.org 1>&2
  exit /b 1
)
